 ...
 <div  align="center">
  <div class="main">
   <h2 class="sign">Create C Language question</h2> 
	  ...
	  <form onsubmit="return validate8();" action="cquestion5" method="post">  
              
              <p>
            <input id="scode" onkeypress="return (event.charCode > 47 && event.charCode < 58)" type="text" class="un "  placeholder="Subject Code eg.101" name="scode" /> <br>
              </p>
              <p>
        ...
        <form onsubmit="return validate9();" action="cdemo" method="post">
              <p>
