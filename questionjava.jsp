...
body { 
  ...
  color: white; 
    ...
    <body>
         <%!
 String mobilenumber,type,firstname,type1;
%>
   <%
    ...
    <td><%= mobilenumber%></td>
     ...
     <p align="center">&nbsp;</p>
      ...
      <%
         ...
         PreparedStatement stmt2=con.prepareStatement("select * from questiondemo where scode='301'");
         ResultSet rs1=stmt2.executeQuery();
         if(rs1.next())
         {
             scode=rs1.getInt(1);
         }
          ResultSet rs=stmt1.executeQuery("select * from questiondemo where scode='"+scode+"'");
