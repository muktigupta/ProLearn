  <!DOCTYPE html>
  <html>
  <head><title>Java Language</title>
  <style>
...
body { 
 ...
 <div  align="center">
  <div class="main">
   <h2 class="sign">Create Java Language question</h2> 
      
	  <form onsubmit="return validate8();" action="javaquestion5" method="post">  
              <p>
       ...
       <h3>
        ...
        <form onsubmit="return validate9();" action="javademo" method="post">
            <p>
